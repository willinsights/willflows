...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const staticPages = [
      ...
      { loc: '/para-agencias', priority: '0.9', changefreq: 'monthly' },
      { loc: '/para-produtoras', priority: '0.9', changefreq: 'monthly' },
      { loc: '/vs', priority: '0.8', changefreq: 'monthly' },
      { loc: '/vs/asana', priority: '0.8', changefreq: 'monthly' },
      { loc: '/vs/clickup', priority: '0.8', changefreq: 'monthly' },
      { loc: '/vs/trello', priority: '0.8', changefreq: 'monthly' },
