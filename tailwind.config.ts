  ...
  theme: {
  	...
  	extend: {
  		...
  		boxShadow: {
  			...
  			'glass-lg': '0 12px 40px -8px rgba(130, 36, 227, 0.12)',
  			glow: '0 0 16px hsl(var(--primary) / 0.2)',
  			'glow-lg': '0 0 32px hsl(var(--primary) / 0.25)',
  			soft: '0 1px 3px 0 rgba(0, 0, 0, 0.04)',
  			elevated: '0 4px 16px -2px rgba(0, 0, 0, 0.1)'
  		},
  		spacing: {
  			'18': '4.5rem',
  			'22': '5.5rem'
