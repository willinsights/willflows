...
export function ApprovalShareLink({ taskId, workspaceId, projectId, className }: ApprovalShareLinkProps) {
  const { token, generateToken, revokeToken, getApprovalUrl } = useVideoApproval(taskId, projectId);
