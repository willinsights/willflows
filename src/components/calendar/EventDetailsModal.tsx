...
export function EventDetailsModal({ event, open, onOpenChange, onEdit }: EventDetailsModalProps) {
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 mt-4">
            ...
            {/* Video Call - opens MeetingRoomModal */}
            {event.videoCallUrl && (
              <div className="flex items-start gap-3">
                {isMeetLink ? (
                ...
                <div className="flex-1">
                  ...
                  >
                    {isMeetLink ? 'Abrir Sala de Reunião' : 'Abrir videochamada'}
      ...
      {event.videoCallUrl && (
        <MeetingRoomModal
          open={showMeetingRoom}
          onOpenChange={setShowMeetingRoom}
          meetUrl={event.videoCallUrl}
          title={event.title}
