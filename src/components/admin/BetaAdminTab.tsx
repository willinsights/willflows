                        ...
                        <TableCell>
                          <div className="flex gap-1">
                            ...
                            {invite.email && !invite.used_at && (
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => resendInviteEmail(invite)} disabled={sendingEmail === invite.id}>
                                    {sendingEmail === invite.id ? <Loader2 className="h-4 w-4 animate-spin" /> : <Mail className="h-4 w-4" />}
                                  </Button>
                                </TooltipTrigger>
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  ...
                                  <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction onClick={() => deleteInvite(invite.id)} className="bg-destructive text-destructive-foreground">
                                      Eliminar
                                    </AlertDialogAction>
                                  </AlertDialogFooter>
                                </AlertDialogContent>
              ...
              <CardHeader className="flex flex-row items-center justify-between py-4">
                ...
                {pendingWaitlist.length > 0 && (
                  <Button size="sm" onClick={approveAllWaitlist} disabled={approvingAll}>
                    {approvingAll ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <MailCheck className="h-4 w-4 mr-2" />}
                ...
                <TableBody>
                  {loading ? (
                    ...
                    <TableRow key={entry.id}>
                      ...
                      <TableCell className="hidden md:table-cell text-muted-foreground">{entry.name || '—'}</TableCell>
                      <TableCell>
                        {entry.invited_at ? (
                          <Badge variant="default" className="bg-green-600"><UserCheck className="h-3 w-3 mr-1" />Convidado</Badge>
                        ) : (
                      ...
                      <TableCell>
                        <div className="flex gap-1">
                          {!entry.invited_at && (
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => inviteFromWaitlist(entry, true)}>
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                <AlertDialogAction onClick={() => deleteWaitlistEntry(entry.id)} className="bg-destructive text-destructive-foreground">
                                  Eliminar
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
