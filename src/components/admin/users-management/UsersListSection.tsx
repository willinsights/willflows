/**
 * UsersListSection - Full users list with filtering and actions
 * Moved from UsersTab.tsx for the unified Users Management tab
 */
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {confirmAction?.type === 'block' && 
                `O utilizador ${confirmAction.user.email} será impedido de aceder ao sistema.`}
              {confirmAction?.type === 'unblock' && 
                `O utilizador ${confirmAction.user.email} voltará a ter acesso ao sistema.`}
              {confirmAction?.type === 'reset' && 
                `Será enviado um email para ${confirmAction.user.email} com instruções para redefinir a password.`}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
