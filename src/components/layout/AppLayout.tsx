  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
        ...
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary/[0.27] dark:bg-primary/[0.33] rounded-full blur-[150px] translate-x-1/4 -translate-y-1/4" />
        
        {/* Secondary purple spot - bottom left */}
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-primary/[0.23] dark:bg-primary/[0.27] rounded-full blur-[120px] -translate-x-1/4 translate-y-1/4" />
        
        {/* Third purple spot - center for depth */}
        <div className="absolute top-1/2 left-1/4 w-[500px] h-[500px] bg-primary/20 dark:bg-primary/25 rounded-full blur-[100px]" />
      </div>
