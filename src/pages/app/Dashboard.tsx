            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                {loading ? (
                  ...
                  <span className="text-2xl font-bold">{formatCurrency(metrics.custos)}</span>
                )}
              </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                {loading ? (
                  ...
                  <span className="text-2xl font-bold text-primary">{formatCurrency(metrics.lucro)}</span>
                )}
              </div>
        ...
        >
          <Card className="glass-card h-full">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <Button variant="ghost" size="sm" className="text-primary" onClick={() => navigate('/app/captacao')}>
                Ver todos
            ...
            <CardContent>
              <div className="text-center py-4">
                {loading ? (
                  ...
                  <>
                    <p className="text-3xl font-bold text-warning">{formatCurrency(metrics.pendingPayments)}</p>
              ...
              <Button variant="outline" className="w-full mt-2" onClick={() => navigate('/app/pagamentos')}>
                Ver pagamentos
