...
// Placeholder component - will be expanded with full Kanban functionality
export default function Captacao() {
  const [view, setView] = useState<'kanban' | 'list'>('kanban');

  // Mock columns
  const columns = [
    { id: '1', name: 'A agendar', color: '#6b7280', tasks: 3 },
    { id: '2', name: 'Agendado', color: '#3b82f6', tasks: 5 },
    { id: '3', name: 'Em execução', color: '#f59e0b', tasks: 2 },
    { id: '4', name: 'Entregue', color: '#22c55e', tasks: 8, isFinal: true },
  ];
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 pb-4">
        <div>
          ...
          <p className="text-muted-foreground">Gerencie as gravações e sessões fotográficas</p>
        </div>
